...
WHERE slug = 'hebraic_worldview_covenant_fidelity' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'accuracy_original_languages' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'early_church_alignment' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'covenant_kingdom_terminology' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'sacred_names_divine_titles' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'hebraic_tense_fidelity' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'modern_english_clarity' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'avoidance_archaic_language' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'doctrinal_stability' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'resistance_replacement_theology' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'jewish_cultural_context' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'precision_covenant_terms' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'law_grace_integration' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'risk_of_misinterpretation' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'discipleship_suitability' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'narrative_coherence' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'eschatological_clarity' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'translation_consistency' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'pastoral_teaching_utility' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';
...
WHERE slug = 'doctrinal_drift_risk' AND category_id = 'b1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e';

-- Create a master evaluation prompt item
INSERT INTO category_items (
  id, category_id, collection_id, slug, name, item_type, content, content_json, display_order, priority, is_active, version, created_at, updated_at
)
VALUES (
  gen_random_uuid(),
